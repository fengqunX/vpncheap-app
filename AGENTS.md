# AGENTS.md — vpncheap-app

Codex/agent entrypoint. Read `CLAUDE.md` first. This repository is PUBLIC: keep internal notes out of it. The rule below is duplicated in `CLAUDE.md` on purpose and must stay in sync.
